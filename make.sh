...
ghdl -a perceptron_fpga/perceptron.vhdl \
        perceptron_fpga/mnist_weights.vhdl \
        perceptron_fpga/mnist_inputs.vhdl \
...
timeout 30 ghdl -r mnist_matrix_test --vcd=out/mnist_matrix_test.vcd || true
